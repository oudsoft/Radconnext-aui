...
const fieldOptions = [{
     ...
     name_th: 'ชื่อโรงพยาบาล'
},
{
     name_en: 'patient_name',
     name_th: 'ชื่อผู้ป่วย (อังกฤษ)'
},
{
     name_en: 'patient_name_th',
     name_th: 'ชื่อผู้ป่วย (ไทย)'
},
{
     name_en: 'patient_name_en_th',
     name_th: 'ชื่อผู้ป่วย ไทยหรืออังกฤษ'
},
{
     name_en: 'patient_hn',
     name_th: 'HN ผู้ป่วย'
...
},
{
     ...
     name_th: 'สิทธิผู้ป่วย'
},
{
     name_en: 'patient_doctor',
     name_th: 'หมอเจ้าของไข้'
},
{
